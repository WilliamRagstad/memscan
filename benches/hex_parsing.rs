...
fn benchmark_hex_parsing(c: &mut Criterion) {
    ...
    let test_patterns = [
        ...
        ("long_compact", "4D5A90000300000004000000FFFF00000800000000000000"),
        ("long_spaced", "4D 5A 90 00 03 00 00 00 04 00 00 00 FF FF 00 00 08 00 00 00 00 00 00 00"),
...
fn benchmark_hex_parsing_variations(c: &mut Criterion) {
    ...
    let variations = [
        ...
        ("double_spaces", "DE  AD  BE  EF  12  34  56  78  CA  FE  BA  BE"),
